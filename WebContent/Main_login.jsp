...
<!-- Header -->
		...
		<!-- Menu -->
			...
			<section id="banner">
				<div class="inner">
					<header>
						<h1>Volunteer Reservation system</h1><br>
					</header>

					<div style="display:flex;justify-content:center;">

						<div style="margin:50px">
						<a href="index.jsp" class="button alt small" onmouseout="this.className='button alt small'" onmouseover="this.className='button small'">
						...
						<div style="margin:50px">
						<a href="mypage.jsp" class="button alt small"  onmouseout="this.className='button alt small'" onmouseover="this.className='button small'">
